...
class ViNT_lstm(nn.Module):
    def __init__(
        ...
        self.lstm_single = nn.LSTM(
            input_size=obs_encoding_size,
    ...
    def forward(self, obs_img: torch.tensor):
        ...
        lstm_output, _ = self.lstm_single(obs_encoding)
        obs_encoding_tokens = self.output_layer(lstm_output)
