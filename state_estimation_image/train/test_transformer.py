...
from DND_train.models.dnd.vint_trans import ViNT_trans
...
def evaluate_dnd(
    ...
    with tqdm.tqdm(
        ...
        for i, data in enumerate(tepoch):
            ...
            # batch_obs_images = batch_obs_images[:, 9:12, :, :]
...
def main(config):
    ...
    if config["vision_encoder"] == "trans":
        vision_encoder = ViNT_trans(
...
if __name__ == "__main__":
    ...
    config = user_config
    config['load_run'] = 'state_image/Transformer'
    main(config)